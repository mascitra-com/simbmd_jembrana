	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				...
				<div class="btn-group">
					<a href="{{site_url('aset/kiba/maps')}}" class="btn btn-primary" target="_blank">Maps</a>
					...
					<tbody>
						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									<a href="{{site_url('aset/kiba/detail/'.$item->id)}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
									@if($superadmin)
									...
									@if($item->garis_lintang != "<span class='text-secondary'><i>kosong</i></span>")
                                        <a href="{{site_url('aset/kiba/maps/'.$item->garis_lintang.'/'.$item->garis_bujur)}}" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-map-marker"></i></a>
                                    @else
