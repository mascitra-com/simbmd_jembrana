...
<head>
	<meta charset="UTF-8">
	<title>SIMBMD KABUPATEN JEMBRANA - LOGIN</title>
					...
					<div class="card-body">
						<form action="{{site_url('authentication/do_login')}}" method="POST">
						    ...
						    <img src="http://simbmd-jembrana.mascitra.com/res/images/logo.png"
                             alt="Logo Kabupaten Jembrana" class="img-responsive" width="100px">
                            </div>
							<div class="mb-4 text-bigger text-center">
								<span class="text-bolder">SIMBMD</span><span>JEMBRANA</span>
							</div>
